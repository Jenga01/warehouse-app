...
INTRO
    ...
    'routes' => [
        [
             ...
             */
            'exclude' => [
                 'sanctum/csrf-cookie', 'login', 'product/{id}', 'product-details-history/{id}',
                 'product-details-history/{id}', 'lang/{locale}', 'password/lang/{locale}', 'password/reset/lang/{locale}',
                 'product/lang/{locale}', '_debugbar/open', '_debugbar/clockwork/{id}', '_debugbar/telescope/{id}', '_debugbar/assets/stylesheets',
                 '_debugbar/assets/javascript', '_debugbar/cache/{key}/{tags?}', 'logout', 'register', 'register', 'password/reset',
                 'password/email', 'password/reset/{token}', 'password/reset', 'password/confirm', 'password/confirm', '/',
                 'products', 'restore/{id}'
